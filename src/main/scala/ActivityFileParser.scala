...
//this parser contains methods for converting any of the following files to a standard Dataframe
//GPX - readGPXToDataFrame
//FIT file - To be developed

object ActivityFileParser {


  private def matchActivityType (activityName: String) : String = {
